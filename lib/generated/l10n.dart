...
class S {
  ...
  /// `Create cross-platform applications that are high-performing and have a flexible design.`
  ...
  /// `Create the web interfaces of the future with dynamic and responsive design.`
  String get React_desctiption {
    return Intl.message(
      'Create the web interfaces of the future with dynamic and responsive design.',
      name: 'React_desctiption',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Create reliable solutions for web, server, and enterprise systems that are scalable.`
  String get java_description {
    return Intl.message(
      'Create reliable solutions for web, server, and enterprise systems that are scalable.',
      name: 'java_description',
      desc: '',
      args: [],
    );
  }
